<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Prueba5.Login" %>
    ...
    <script src="Scripts/bootstrap.min.js"></script>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                <a class="nav-item nav-link active" href="#" style="color: #0C9203">Inicio De Sesión<span class="sr-only">(current)</span></a>
            </div>
        </div>
    </nav>

        <asp:Panel ID="Panel1" runat="server" CssClass="testboc" >
            <table border="0" style="width:100%; text-align: center; table-layout: auto; height: 443px;" id="MainTable" >
                <tr>
                    <td colspan="2">
                          <br />          
                    </td>
                ...
                <tr>
                    <td colspan="2" class="auto-style1">
                        <asp:TextBox ID="txtUsuario" runat="server" CssClass="" Width="200px" placeholder="Usuario" OnTextChanged="txtUsuario_TextChanged"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txtContrasena" runat="server" CssClass="" TextMode="Password" Width="200px" placeholder="Contraseña"></asp:TextBox>
                    </td>   
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnIngresar" runat="server" CssClass="btn btn-success" OnClick="btnIngresar_Click" Text="Iniciar" Width="120px" />
                    </td>
                    <td>
                        <asp:Button ID="btnRecuperar" runat="server" CssClass="btn btn-danger" Text="Crear Cuenta" Width="120px" OnClick="btnRecuperar_Click" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
